    ...
    while (playAgain == true)
    {
        ...
        if (choice == 1)
            ...
            do
            {
                ...
                hit = hitSuccess(p2DefenseBoard, xCoordinate, yCoordinates);
                if (hit == true)
                {
                    //Check gameOver
                    gameOver = GAMEOVER(p1AttackBoard, p2DefenseBoard);
                }
                //updateboard
                ...
                hit = true;
                hit = hitSuccess(p1DefenseBoard, xCoordinate, yCoordinates);

                if (hit == true)
                {
                    //Update gameOver
                    gameOver = GAMEOVER(p2AttackBoard, p1DefenseBoard);
                }
                //updateboard
    ...
    *y = -1;
    ...
    do {
        ...
        else
        {
            ...
            {
                cout << "Your hit has been confirmed" << endl;
                *x = tempX;
                *y = tempY;
            }
        }
...
{
    if (compareBoard(victim, attacker)==false)
    {   
